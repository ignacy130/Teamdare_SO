...
namespace Teamdare.Resources
{
	public class ResourcesStrings
	{
		...
		public const string AdventureIntroduceYourselfChallengeDescription = "Talk to the person on your right during break... Yeah, just start with weather! ;) He'll appreciate it! " +Emoji.Sunny;
		public const string AdventureLunchChallengeTitle = "Let's hunt!";
		public const string AdventureLunchChallengeDescription = "Ask your peers when they are heading to the hunt... to the lunch. " + Emoji.Hamburger;
		public const string AdventureSelfieChallengeTitle = "Exegi monumentum";
		public const string AdventureSelfieChallengeDescription = "Now, that you know your colleagues it's to time be remembered forever! Let's take a selfie with them! " + Emoji.Camera;
		...
		public const string AdventureCoffieWithChallengeDescription = "Sometimes even greates heroes need more energy! Ask colleague on your right for a coffee break. " + Emoji.Coffee;
		public const string AdventureShopChallengeTitle = "Show me your goods!";
		public const string AdventureShopChallengeDescription = "Even so well managed company as the one you started working for may lack some goods. Ask your colleagues where is the nearest shop. " + Emoji.Department_Store;
		public const string AdventureBeerChallengeTitle = "Golden intoxicant";
		public const string AdventureBeerChallengeDescription = "It's Friday afternoon. If you don't have plans so may some of your peers. Beer with your new coleagues sounds good, doesn't it? " + Emoji.Beers;
		...
		public const string AdventureKitchenChallengeDescription = "Have a fresh deer but no microwave to prepare it? Ask you peer where is the kitchen! " + Emoji.Fork_And_Knife;
		public const string AdventureToiletChallengeTitle = "The king's seat";
		public const string AdventureToiletChallengeDescription = "Don't hold it in yourself! Ask her... where is the restroom " + Emoji.Runner;
		public const string AdventureRelaxRoomChallengeTitle = "Little Lie";
		public const string AdventureRelaxRoomChallengeDescription = "Little lie(s) are essential at workplace. Come back refreshed in 15 minutes! " + Emoji.Bath;
